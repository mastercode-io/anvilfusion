...
class PageBase:
    ...
    def form_show(self, **args):
        ...
        self.container_el = anvil.js.window.documenet.getElementById(self.container_id)
        ...
        self.page_el = anvil.js.window.documenet.getElementById(f'{self.page_el_id}')
        self.show()
    ...
    def page_content(self, value):
        ...
        if self.page_el:
            content_el = anvil.js.window.documenet.getElementById(f'{self.page_el_id}-content')

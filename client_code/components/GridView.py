...
GRID_DEFAULT_TOOLBAR_ITEMS = [
    {'id': 'Delete', 'text': 'Delete', 'prefixIcon': 'e-delete', 'tooltipText': 'Delete', 'align': 'Right', 'style': 'color: #d6292c;'},
    ...
    {'id': 'Add', 'text': 'Add', 'prefixIcon': 'e-add', 'tooltipText': 'Add', 'align': 'Right'}, 
    # {'text': 'Edit'}, 
    # {'text': 'Delete'}, 
]
